...
test("maintained-fork manifest documents Windows-only entrypoints and boundaries", () => {
  ...
  expect(read("docs/UPSTREAM.md")).toContain("1108fa6298fab765dce6a052b7edc2510c0bad17");
  ...
  expect(read("tools/upstream_baseline.json")).toContain('"latestPullRequest": 355');
  expect(read("tools/upstream_baseline.json")).toContain('"latestPullRequestHead": "1108fa6298fab765dce6a052b7edc2510c0bad17"');
