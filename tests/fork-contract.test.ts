...
test("maintained-fork manifest documents Windows-only entrypoints and boundaries", () => {
  ...
  expect(read("docs/UPSTREAM.md")).toContain("df0224756d639edfa2124ed96c1dad75e05e06df");
  ...
  expect(read("tools/upstream_baseline.json")).toContain('"latestPullRequest": 347');
  expect(read("tools/upstream_baseline.json")).toContain('"latestPullRequestHead": "df0224756d639edfa2124ed96c1dad75e05e06df"');
