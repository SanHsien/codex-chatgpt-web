...
whole-workspace dependency freshness and Bun audit, upstream verification, and whitespace. Unit
tests include positive, malformed, and unavailable fixture cases without network access.
...
offline gate, and unit tests must never be reported as proof of those outcomes.
