...
PR at open [#470](https://github.com/miuuyy/codex-chatgpt-web/pull/470) head
`79be7ff23b16ba49cf680ebcba3b3cc6c395bbcf`, and the latest non-PR issue at
[#467](https://github.com/miuuyy/codex-chatgpt-web/issues/467); no #471-or-later item exists. The
...
at `e85e3693fdb4e3e033348c08df0298c20fcdb612` (tag-object prefix `24250dcf`). No new main or
non-PR issue code exists beyond the reviewed baseline; #470 is a deferred, unmerged feature. This
fork adopts `v5.0.6` as its own release identity without asserting byte-equivalence to upstream. The
complete #425–#470 review and three independent local ports are recorded below; the older inventories
...
| [#470](https://github.com/miuuyy/codex-chatgpt-web/pull/470) | open, non-draft, `MERGEABLE`/`UNSTABLE`; `79be7ff23b16ba49cf680ebcba3b3cc6c395bbcf`; 32 files; actionlint success, Windows/macOS/Linux verify failure; no maintainer review/comments | defer | Broad optional local usage dashboard changes storage, locking, backup/retention, browser acceptance/outcome telemetry, launcher UI/i18n/styles/types, and tests/docs. Re-review only after upstream merges/releases it with green Windows CI and this fork independently validates local-only privacy, corruption/recovery, locking, installer/updater data preservation, acceptance-count semantics, and no representation as official remaining quota. |
...
live-account retained-follow-up scenario is solved and #470 remains an unadopted optional feature.
